import { AfterQueryHandler, BeforeQueryHandler, DeleteResult, InsertOption, InsertResult, LockResult, LockTableOption, SelectOption, UpdateOption, UpdateResult, UpdateRow } from 'ali-rds/lib/types';
/**
 * Operator Interface
 */
