...
import type { PoolConnectionPromisify } from 'ali-rds/lib/types';
import { Operator } from 'ali-rds/lib/operator';
import { RDSConnection } from 'ali-rds/lib/connection';
import { RDSTransaction } from 'ali-rds/lib/transaction';
...
export declare class RDSClient extends Operator {
    #private;
    static get literals(): {
        now: import("ali-rds/lib/literals").Literal;
        Literal: typeof import("ali-rds/lib/literals").Literal;
    };
